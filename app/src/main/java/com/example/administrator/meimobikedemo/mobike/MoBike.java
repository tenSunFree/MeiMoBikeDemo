package com.example.administrator.meimobikedemo.mobike;
...
public class MoBike {
    ...
    private void createBody(View childView) {
        ...
        Shape shape = null;
        Boolean isCircle = (boolean) childView.getTag(com.meis.widget.R.id.wd_view_circle_tag);
        ...
        childView.setTag(com.meis.widget.R.id.wd_view_body_tag, body);
    ...
    private boolean isBodyView(View view) {
        Body body = (Body) view.getTag(com.meis.widget.R.id.wd_view_body_tag);
        return body != null;
    }
